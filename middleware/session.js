...
var sessionStore = session({store: new redisStore({ client: redisClient, ttl: config.cache.session_ttl }), proxy: true, resave: true, saveUninitialized: true, secret: '2ed99a026ca3481eafd587535aeef274', cookie: { path: '/', httpOnly: true, secure: false, maxAge: null, expires: false }});
